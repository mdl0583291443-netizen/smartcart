"""Rami Levy PriceFull (online schema family) -> common normalized
contract mapping.
...
The "standard" schema family has no normalize_standard_item here -- not
required by any approved test.
"""
